            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <div class="position-relative text-center my-4">
                  <p class="mb-0 fs-4 px-3 d-inline-block bg-body text-dark z-index-5 position-relative">Halaman Login Admin
                  </p>
                ...
                <form action="{{ route('admin_login') }}" method="post">
                  ...
                  <!-- <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a class="text-primary fw-medium" href="{{ url('/public/assets/themes/modernize-bootstrap/dist') }}/main/authentication-forgot-password.html">Forgot
                      Password ?</a>
                  </div> -->
